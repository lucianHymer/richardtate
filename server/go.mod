...
require (
	...
	github.com/ggerganov/whisper.cpp/bindings/go v0.0.0-20251101123828-999a7e0cbf84 // indirect
	...
	github.com/xaionaro-go/observability v0.0.0-20250111142240-5d72f17a6d12 // indirect
